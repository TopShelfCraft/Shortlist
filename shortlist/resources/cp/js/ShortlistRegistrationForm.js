(function($){
    ...
    if (typeof Craft.Shortlist === typeof undefined) {
        Craft.Shortlist = {};
    }
     ...
     */
    Craft.Shortlist.RegistrationForm = Craft.BaseElementIndex.extend({
        licenseKey: null,
        ...
        loadLicenseInfo: function(action) {
            Craft.postActionRequest('shortlist/license/getLicenseInfo', $.proxy(function(response, textStatus) {
        ...
        handleUnregisterLicenseFormSubmit: function(ev) {
            ...
            Craft.postActionRequest('shortlist/license/unregister', $.proxy(function(response, textStatus) {
        ...
        handleUpdateLicenseFormSubmit: function(ev) {
            ...
            Craft.postActionRequest('shortlist/license/updateLicenseKey', data, $.proxy(function(response, textStatus) {
        ...
        handleTransferLicenseFormSubmit: function(ev) {
            ...
            Craft.postActionRequest('shortlist/license/transfer', $.proxy(function(response, textStatus) {
