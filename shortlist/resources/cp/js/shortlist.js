...
(function ($) {
    ...
    Craft.ShortlistUpgradeModal = Garnish.Modal.extend(
        {
            $container: null,
            $body: null,
            $compareScreen: null,
            ...
            init: function (settings) {
                ...
                Craft.postActionRequest('shortlist/license/getUpgradeModal', $.proxy(function (response, textStatus) {
            ...
            onTestBtnClick: function (ev) {
                ...
                Craft.postActionRequest('shortlist/license/testUpgrade', data, $.proxy(function (response, textStatus) {
                    if (textStatus == 'success') {
            ...
            submitPurchase: function (ev) {
                ...
                if (validates) {
                    ...
                    Stripe.createToken(ccData, $.proxy(function (status, response) {
                        if (!response.error) {
                            // Pass the token along to Elliott to shortlist the card
                            var data = {
                            ...
                            Craft.postActionRequest('shortlist/license/purchaseUpgrade', data, $.proxy(this, 'onPurchaseUpgrade'));
                        }
                        else {
